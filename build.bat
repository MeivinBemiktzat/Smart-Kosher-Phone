...
pip install nuitka zstandard ordered-set PyQt6 bleak sounddevice vosk winsdk --quiet
...
python -m nuitka ^
  ...
  --output-dir=dist ^
  --include-package=app --include-package=bleak --include-package=vosk --include-package=winsdk ^
...
pyinstaller --onefile --windowed --name SmartKosherPhone --distpath dist ^
  ...
  --hidden-import bleak --hidden-import bleak.backends.winrt --hidden-import winsdk ^
